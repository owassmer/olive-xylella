...
Reduce the projected economic loss from *Xylella fastidiosa* by legal computational means. Anchors (verified from Schneider et al. 2020 PNAS): Italy €1.86–5.17B over 50 years without resistant replant, €0.59–1.57B with; resistant-cultivar benefit €1.27–3.60B; slowing spread ≈ €0.5–1.3B; Spain tail up to €16.86B.
...
- Free Sentinel-2 (native and 2.5 m super-resolved) shows no individual-tree pre-diagnostic signal on 1,679 matched official pairs: `nowcast/NEGATIVE.md`, `nowcast/ARTIFACT_A.md`.
- Resistance Decoder v1 (`data/decoder/v1-targets.md`): ranked targets with real locus IDs; retained as a scientific artifact and partner credibility material, not a program line.
- Adversarial review corpus: `queries/telos-review-S{0,1,2,4,7,8,9}-*.md` + `queries/telos-synthesis.md`.

## One-sentence contract

CORDON exists to cut real losses from Xylella by shipping verified, honestly-caveated decision information — playbook, exposure briefs, cultivar field evidence, front rate, surveillance gaps — to the producers and authorities who act, with every claim licensed, cited, and within the red lines.
