...
| A1 — temporal S2 | Does within-pixel anomaly vs the pixel's own seasonal baseline and nearby controls carry signal despite mixing? | Open |
| A2 — S2 + VHR unmixing | Was the A0 null caused by crown/soil dilution in the 100–400 m² pixel? Test: paired Δ vs crown fraction | Open |
| A3 — released crown-scale optical | Do Crecco WV2 rasters (2019–2021) and Puglia 0.15 m CIR show crown-level precursor or progression on diagnosed trees? | Open; rasters not yet inspected |
