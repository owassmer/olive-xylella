# CORDON — project bindings

Governing doctrine (by reference): `/Users/owenwassmer/dev/LEA_Control_Center/AGENTIC_DEVELOPMENT_FIRST_PRINCIPLES.md`

Program contract: `CORDON.md`. Wiki schema: `SCHEMA.md`.
